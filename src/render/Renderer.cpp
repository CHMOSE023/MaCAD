...
// Generated by shaderc at build time, DX11 profile.
...
namespace macad::render {
    ...
    bool Renderer::createProgram() {
        bgfx::ShaderHandle vsh =
            bgfx::createShader(bgfx::makeRef(vs_mesh_dx11, sizeof(vs_mesh_dx11)));
        bgfx::ShaderHandle fsh =
            bgfx::createShader(bgfx::makeRef(fs_mesh_dx11, sizeof(fs_mesh_dx11)));
